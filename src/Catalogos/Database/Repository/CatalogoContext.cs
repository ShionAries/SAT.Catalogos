...
namespace Jaeger.SAT.Catalogos.Abstractions {
    ...
    public abstract class CatalogoContext<T> : ICatalogoGeneric<T> where T : class, new() {
        ...
        public DateTime? Actualizacion {
            get {
                if (this._Catalogo.Actualizacion >= new DateTime(1900, 1, 1))
                    return this._Catalogo.Actualizacion;
                return null;
            }
            set { this._Catalogo.Actualizacion = value; }
        }
        ...
        public int Import(System.Data.DataTable dataTable) {
            ...
            this.Items = mapper.Map(dataTable).ToList();
