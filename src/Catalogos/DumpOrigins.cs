    ...
    public class DumpOrigins {
        ...
        protected List<IOrigin> Default() {
            return new List<IOrigin>() {
                ...
                new ConstantOrigin("Correos apócrifos identificados", "http://omawww.sat.gob.mx/contacto/contactenos/Paginas/lista_correos_apocrifos.aspx", importer: typeof(Update.Importers.CorreoApocrifoImporter)) { AllowUpdate = true },
