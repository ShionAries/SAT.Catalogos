...
namespace Jaeger.SAT.Catalogos.Repository.Ccp20 {
    ...
    /// </summary>
    [JsonObject("item")]
    public class DocumentoAduaneroRepository : RepositoryContext<CveDocumentoAduanero>, IDocumentoAduaneroRepository, IGeneralRepository { 
        public DocumentoAduaneroRepository() {
            this.Title = "Catálogo de Documentos Aduaneros";
            this.FileName = "CatCcp20DocumentosAduaneros.json";
            this.Version = "1.0";
        }
