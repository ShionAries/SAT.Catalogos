...
namespace Jaeger.SAT.Catalogos.Repository {
    ...
    /// </summary>
    public class MaterialPeligrosoRepository : RepositoryContext<CveMaterialPeligroso>, IClaveMaterialPeligrosoRepository, IGeneralRepository {
        public MaterialPeligrosoRepository() {
            Title = "Catálogo de materiales peligrosos.";
            FileName = "CatalogoMaterialPeligroso.json";
            Version = "2.0";
        }
