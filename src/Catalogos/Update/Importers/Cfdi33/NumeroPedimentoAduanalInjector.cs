...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi33 {
    ...
    /// </summary>
    public class NumeroPedimentoAduanalInjector : AbstractInjector, IInjector {
        public NumeroPedimentoAduanalInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new NumPedimentoAduanaRepository() { LastUpdate = this.LastUpdate };
        }
    }
}