...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi33 {
    ...
    /// </summary>
    public class ProdServInjector : AbstractInjector, IInjector {
        public ProdServInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new ProdServsRepository() { LastUpdate = this.LastUpdate };
        }
    }
}