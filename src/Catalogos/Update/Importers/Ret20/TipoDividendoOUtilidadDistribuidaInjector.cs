...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ret20 {
    ...
    /// </summary>
    internal class TipoDividendoOUtilidadDistribuidaInjector : AbstractInjector, IInjector {
        public TipoDividendoOUtilidadDistribuidaInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
