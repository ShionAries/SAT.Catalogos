...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ret20 {
    ...
    /// </summary>
    internal class ClaveTipoContribuyenteSujetoRetencionInjector : AbstractInjector, IInjector {
        public ClaveTipoContribuyenteSujetoRetencionInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
