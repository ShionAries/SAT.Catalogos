...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ret20 {
    ...
    /// </summary>
    internal class ClaveTipoDividendoOUtilidadDistribuidaInjector : AbstractInjector, IInjector {
        public ClaveTipoDividendoOUtilidadDistribuidaInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
