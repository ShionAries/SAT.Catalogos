...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ret20 {
    ...
    /// </summary>
    internal class ClaveEjercicioInjector : AbstractInjector, IInjector {
        public ClaveEjercicioInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            ...
            if (resultado != null) {
                if (resultado.Count() > 0) {
                    _Repository = new EjercicioRepository {
