...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ret20 {
    ...
    /// </summary>
    internal class TipoContribuyenteSujetoRetencionInjector : AbstractInjector, IInjector {
        public TipoContribuyenteSujetoRetencionInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
