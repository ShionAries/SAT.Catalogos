...
namespace Jaeger.SAT.Catalogos.Update.Importers.Articulo69B {
    internal class ListadoCompletoInjector : AbstractInjector, IInjector {

        public ListadoCompletoInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 1;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new Articulo69BRepository() { LastUpdate = this.LastUpdate } ;
        }
    }
}
