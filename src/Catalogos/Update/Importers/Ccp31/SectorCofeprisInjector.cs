...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class SectorCofeprisInjector : AbstractInjector, IInjector {
        public SectorCofeprisInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new SectorCofeprisRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
