...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class UnidadPesoInjector : AbstractInjector, IInjector {
        public UnidadPesoInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new UnidadPesoRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
