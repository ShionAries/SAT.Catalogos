...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class TransporteInjector : AbstractInjector, IInjector {
        public TransporteInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new RegimenAduaneroRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
