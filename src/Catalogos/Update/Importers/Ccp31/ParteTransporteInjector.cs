...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class ParteTransporteInjector : AbstractInjector, IInjector {
        public ParteTransporteInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new ParteTransporteRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
