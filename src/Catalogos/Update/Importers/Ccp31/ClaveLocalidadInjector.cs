...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// 
    /// </summary>
    public class ClaveLocalidadInjector : AbstractInjector, IInjector {
        public ClaveLocalidadInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new LocalidadRepository() { LastUpdate = this.LastUpdate };
        }
    }
}