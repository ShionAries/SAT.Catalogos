...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class ConfigTransporteInjector : AbstractInjector, IInjector {
        public ConfigTransporteInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new ConfigAutotransporteRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
