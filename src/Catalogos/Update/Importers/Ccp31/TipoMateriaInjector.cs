...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class TipoMateriaInjector : AbstractInjector, IInjector {
        public TipoMateriaInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new TipoMateriaRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
