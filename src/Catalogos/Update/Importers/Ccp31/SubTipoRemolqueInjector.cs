...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class SubTipoRemolqueInjector : AbstractInjector, IInjector {
        public SubTipoRemolqueInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new SubTipoRemCatalogo() { LastUpdate = this.LastUpdate };
        }
    }
}
