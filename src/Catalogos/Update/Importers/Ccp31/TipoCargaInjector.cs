...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class TipoCargaInjector : AbstractInjector, IInjector {
        public TipoCargaInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new TipoCargaRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
