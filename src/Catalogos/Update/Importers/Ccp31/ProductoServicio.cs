...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class ProductoServicio : AbstractInjector, IInjector {
        public ProductoServicio(DataTable dataTable) : base(dataTable) {
            this._SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new ProdServCPRepository(this.LastVersion);
        }
    }
}
