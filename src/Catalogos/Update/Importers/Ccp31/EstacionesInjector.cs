...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class EstacionesInjector : AbstractInjector, IInjector {
        public EstacionesInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new EstacionesRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
