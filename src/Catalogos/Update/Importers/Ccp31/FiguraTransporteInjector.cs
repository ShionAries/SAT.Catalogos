...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class FiguraTransporteInjector : AbstractInjector, IInjector {
        public FiguraTransporteInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new FiguraTransporteRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
