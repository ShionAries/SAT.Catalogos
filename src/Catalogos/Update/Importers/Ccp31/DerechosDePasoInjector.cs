...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class DerechosDePasoInjector : AbstractInjector, IInjector {
        public DerechosDePasoInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new DerechosDePasoRepository() { LastUpdate = this.LastUpdate };
        }
    }
}
