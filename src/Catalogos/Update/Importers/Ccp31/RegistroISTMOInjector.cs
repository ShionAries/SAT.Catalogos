...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp31 {
    ...
    /// </summary>
    internal class RegistroISTMOInjector : AbstractInjector, IInjector {
        public RegistroISTMOInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new RegistroISTMORepository() { LastUpdate = this.LastUpdate };
        }
    }
}
