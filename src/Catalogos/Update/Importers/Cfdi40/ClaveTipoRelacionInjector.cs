...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class ClaveTipoRelacionInjector : AbstractInjector, IInjector {
        public ClaveTipoRelacionInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new TipoRelacionCFDIRepository(this.LastVersion);
        }
    }
}