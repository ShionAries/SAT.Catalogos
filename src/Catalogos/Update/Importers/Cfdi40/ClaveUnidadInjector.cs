...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class ClaveUnidadInjector : AbstractInjector, IInjector {
        public ClaveUnidadInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new UnidadesRepository(this.LastVersion);
        }
    }
}
