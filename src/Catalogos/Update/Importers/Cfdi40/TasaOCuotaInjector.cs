...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class TasaOCuotaInjector : AbstractInjector, IInjector {
        public TasaOCuotaInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new TasaOCuotaRepository() { LastUpdate = this.LastUpdate };
        }
    }
}