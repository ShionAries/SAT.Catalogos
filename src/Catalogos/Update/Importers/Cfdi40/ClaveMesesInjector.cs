...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    /// <summary>
    /// catalgo de claves de meses
    /// </summary>
    public class ClaveMesesInjector : AbstractInjector, IInjector {
        public ClaveMesesInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new MesesRepository(this.LastVersion);
        }
    }
}