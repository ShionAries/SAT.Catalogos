...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class ExportacionInjector : AbstractInjector, IInjector {
        public ExportacionInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new ExportacionRepository() { LastUpdate = this.LastUpdate };
        }
    }
}