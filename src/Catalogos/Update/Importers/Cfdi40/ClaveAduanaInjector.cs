...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class ClaveAduanaInjector : AbstractInjector, IInjector {
        public ClaveAduanaInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new AduanasRepository(this.LastVersion);
        }
    }
}