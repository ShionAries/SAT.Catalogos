...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    public class ClaveObjetoImpuestoInjector : AbstractInjector, IInjector {
        public ClaveObjetoImpuestoInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new ObjetoImpRepository(this.LastVersion);
        }
    }
}