...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    /// <summary>
    /// catalogo de claves para periodicidad
    /// </summary>
    public class PeriodicidadInjector : AbstractInjector, IInjector {
        public PeriodicidadInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new PeriodicidadRepository() { LastUpdate = this.LastUpdate };
        }
    }
}