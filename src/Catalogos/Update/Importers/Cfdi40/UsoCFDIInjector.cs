...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class UsoCFDIInjector : AbstractInjector, IInjector {
        public UsoCFDIInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new UsoCFDIRepository() { LastUpdate = this.LastUpdate };
        }
    }
}