...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class MunicipioInjector : AbstractInjector, IInjector {
        public MunicipioInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new MunicipioRepository() { LastUpdate = this.LastUpdate };
        }
    }
}