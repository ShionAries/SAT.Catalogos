...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class ClaveTipoFactorInjector : AbstractInjector, IInjector {
        public ClaveTipoFactorInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new TipoFactorRepository(this.LastVersion);
        }
    }
}