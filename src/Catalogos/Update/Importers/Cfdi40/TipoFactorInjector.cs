...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    /// <summary>
    /// catalogo de tipos de factor
    /// </summary>
    public class TipoFactorInjector : AbstractInjector, IInjector {
        public TipoFactorInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new TipoFactorRepository() { LastUpdate = this.LastUpdate };
        }
    }
}