...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    /// <summary>
    /// catalogo de claves para metodos de pago
    /// </summary>
    public class ClaveMetodoPagoInjector : AbstractInjector, IInjector {
        public ClaveMetodoPagoInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
