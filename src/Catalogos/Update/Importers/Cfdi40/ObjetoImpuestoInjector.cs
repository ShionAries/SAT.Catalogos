...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    public class ObjetoImpuestoInjector : AbstractInjector, IInjector {
        public ObjetoImpuestoInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new ObjetoImpRepository() { LastUpdate = this.LastUpdate };
        }
    }
}