...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class AduanaInjector : AbstractInjector, IInjector {
        public AduanaInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Repository = new AduanasRepository() { LastUpdate = this.LastUpdate };
        }
    }
}