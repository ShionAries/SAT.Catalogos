...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class ClaveExportacionInjector : AbstractInjector, IInjector {
        public ClaveExportacionInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new ExportacionRepository(this.LastVersion);
        }
    }
}