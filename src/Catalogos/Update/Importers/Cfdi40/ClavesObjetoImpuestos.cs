...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    public class ClavesObjetoImpuestos : AbstractInjector, IInjector {
        public ClavesObjetoImpuestos(DataTable dataTable) : base(dataTable) {
            _SkipRows = 3;
        }
        ...
        protected override void Fill() {
            var mapper = new Helpers.Mapping.DataNamesMapper<ClaveObjetoImp>();
