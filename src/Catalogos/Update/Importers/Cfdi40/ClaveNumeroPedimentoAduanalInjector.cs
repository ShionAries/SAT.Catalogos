...
namespace Jaeger.SAT.Catalogos.Update.Importers.Cfdi40 {
    ...
    /// </summary>
    public class ClaveNumeroPedimentoAduanalInjector : AbstractInjector, IInjector {
        public ClaveNumeroPedimentoAduanalInjector(DataTable dataTable) : base(dataTable) {
            SkipRows = 3;
        }
