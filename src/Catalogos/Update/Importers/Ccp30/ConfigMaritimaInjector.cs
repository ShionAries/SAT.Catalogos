...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp30 {
    ...
    /// </summary>
    internal class ConfigMaritimaInjector : AbstractInjector, IInjector {
        public ConfigMaritimaInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new ConfigMaritimaRepository();
        }
    }
}
