...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp30 {
    ...
    /// </summary>
    internal class Localidad : AbstractInjector, IInjector {
        public Localidad(DataTable dataTable) : base(dataTable) {
            this._SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            this._Catalogo = new Repository.Cfdi40.LocalidadRepository();
        }
    }
}
