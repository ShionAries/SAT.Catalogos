...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp30 {
    ...
    /// </summary>
    internal class TipoEmbalajeInjector : AbstractInjector, IInjector {
        public TipoEmbalajeInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            _Repository = new TipoEmbalajeRepository();
        }
    }
}
