...
namespace Jaeger.SAT.Catalogos.Update.Importers.Ccp30 {
    ...
    /// </summary>
    internal class ClavesConfigMaritima : AbstractInjector, IInjector {
        public ClavesConfigMaritima(DataTable dataTable) : base(dataTable) {
            this._SkipRows = 3;
        }
        ...
        protected override void Fill() {
            var mapper = new Helpers.Mapping.DataNamesMapper<CveConfigMaritima>();
