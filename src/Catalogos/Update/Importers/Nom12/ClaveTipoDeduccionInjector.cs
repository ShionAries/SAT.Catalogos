...
namespace Jaeger.SAT.Catalogos.Update.Importers.Nom12 {
    ...
    /// </summary>
    internal class ClaveTipoDeduccionInjector : AbstractInjector, IInjector {
        public ClaveTipoDeduccionInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            ...
            if (resultado != null) {
                if (resultado.Count() > 0) {
                    _Repository = new TipoDeduccionRepository(this.LastVersion) {
