...
namespace Jaeger.SAT.Catalogos.Update.Importers.Nom12 {
    ...
    /// catalogo de bancos
    /// </summary>
    internal class ClaveBancoInjector : AbstractInjector, IInjector {
        public ClaveBancoInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            ...
            if (resultado != null) {
                if (resultado.Count() > 0) {
                    _Repository = new BancosRepository(this.LastVersion) {
