...
namespace Jaeger.SAT.Catalogos.Update.Importers.Nom12 {
    ...
    /// </summary>
    internal class ClaveTipoRegimenContratacionInjector : AbstractInjector, IInjector {
        public ClaveTipoRegimenContratacionInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
