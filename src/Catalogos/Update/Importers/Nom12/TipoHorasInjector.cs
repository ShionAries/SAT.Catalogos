...
namespace Jaeger.SAT.Catalogos.Update.Importers.Nom12 {
    ...
    /// </summary>
    internal class TipoHorasInjector : AbstractInjector, IInjector {
        public TipoHorasInjector(DataTable dataTable) : base(dataTable) {
            this.SkipRows = 3;
        }
        ...
        protected override void CreateRepository() {
            ...
            if (resultado != null) {
                if (resultado.Count() > 0) {
                    _Repository = new TipoHorasRepository() {
