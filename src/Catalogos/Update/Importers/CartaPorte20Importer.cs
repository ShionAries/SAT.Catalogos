using System.Data;
using Jaeger.SAT.Catalogos.Update.Importers.Ccp20;

namespace Jaeger.SAT.Catalogos.Update.Importers {
    public class CartaPorte20Importer : AbstractXlsImporter, IImporter {
        public CartaPorte20Importer() : base() { }

        public CartaPorte20Importer(Scraping.Interfaces.IOrigin origin, IConfiguration configuration) : base(origin, configuration) { }
